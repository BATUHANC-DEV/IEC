    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl leading-relaxed">
              Endüstriyel tesisler için PLC, SCADA ve HMI tabanlı otomasyon sistemleri tasarlıyoruz. Süreç kontrolü, veri izleme, uzaktan erişim ve sistem entegrasyonu ile operasyonel verimlilik sağlanır.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          >
            <img 
              src="https://images.unsplash.com/photo-1764185800646-f75f7e16e465?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbmR1c3RyaWFsJTIwYXV0b21hdGlvbiUyMHBsYyUyMHN5c3RlbXN8ZW58MXx8fHwxNzczMTgwODQ3fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral" 
        ...
        <div className="container mx-auto px-4 relative text-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto">
              Otomasyon sistemleri konusunda uzman ekibimiz size yardımcı olmaya hazır.
            </p>
            <Link
              to="/#contact"
