...
import panoImage from "figma:asset/7ff12ebf1223e275eab5bcbe72f63f3a6a422a8b.png";

export function PanoSistemleri() {
  const solutions = [
    "AG Dağıtım Panoları",
    "OG Hücre ve Dağıtım Sistemleri",
    "MCC ve Motor Kontrol Panoları",
    "Kompanzasyon Panoları",
    "PLC & Otomasyon Panoları",
    "Tip Testli Üretim ve Saha Montajı",
    "E-Plan Üzerinde Profesyonel Pano Tasarımı",
    "3 Boyutlu (3D) Çizimler ile Hatasız İmalat",
    "Bakım Tecrübesiyle Riskleri Minimize Eden Tasarım",
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl leading-relaxed">
              AG ve OG dağıtım, MCC, kompanzasyon ve otomasyon panolarının projelendirilmesi, tip testli üretimi ve saha montajı yapılmaktadır. IEC standartlarına uygun, güvenli ve modüler çözümler sunulmaktadır.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            {solutions.map((solution, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <p className="text-gray-700 font-medium leading-relaxed pt-2">{solution}</p>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <div className="container mx-auto px-4 relative text-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto">
              Pano sistemleri ve elektrik altyapısı konusunda uzman ekibimiz size yardımcı olmaya hazır.
            </p>
            <Link
              to="/#contact"
