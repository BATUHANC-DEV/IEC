    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl leading-relaxed">
              Elektrik tesisleri için periyodik bakım, termal kamera kontrolleri, izolasyon testleri ve arıza analizleri gerçekleştirilir. Önleyici bakım uygulamaları ile sistem sürekliliği sağlanır.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          >
            <img 
              src="https://images.unsplash.com/photo-1759434775823-40d8b9577a41?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbGVjdHJpY2FsJTIwbWFpbnRlbmFuY2UlMjB0ZWNobmljaWFufGVufDF8fHx8MTc3MzE4MDg0Nnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral" 
              alt="Servis & Bakım" 
        ...
        <div className="container mx-auto px-4 relative text-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto">
              Servis ve bakım hizmetleri konusunda uzman ekibimiz size yardımcı olmaya hazır.
            </p>
            <Link
              to="/#contact"
